...
define("LAN_SIGNUP_72", "תודה על שנרשמת ב] [sitename]! אנחנו פשוט נשלח לך דואל אישור ל [דואל]. אנא לחץ על הקישור אישור בדואל כדי להשלים את ההרשמה שלכם ולהפעיל את החשבון שלך.");
define("LAN_SIGNUP_98", "אישור כתובת האימייל שלך");
define("LAN_SIGNUP_99", "בעיה נתקלנו");
define("LAN_SIGNUP_100", "מנהל הממתין לאישור");
define("LAN_SIGNUP_102", "סרוב להרשמה");
define("LAN_SIGNUP_103", "יותר מדי משתמשים עם אותה כתובת ip:");
define("LAN_SIGNUP_104", "Invalid avatar name	");
define("LAN_SIGNUP_105", "Unable to action your request - please contact the site administrator	");
define("LAN_SIGNUP_106", "Unable to action your request - do you already have an account here?	");
