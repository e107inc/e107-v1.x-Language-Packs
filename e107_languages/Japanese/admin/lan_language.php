...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_languages/Japanese/admin/lan_language.php $
|     $Revision: 12553 $
|     $Id: lan_language.php 12553 2012-01-14 12:53:11Z e107coders $
|     $Author: e107coders $
+----------------------------------------------------------------------------+
*/
define("LANG_LAN_00", "作成できませんでした。（すでに存在しています）");
define("LANG_LAN_01", "削除された（既存の場合）、作成されています。");
define("LANG_LAN_02", "削除できませんでした");
define("LANG_LAN_03", "テーブル");
define("LANG_LAN_05", "インストールされていません");
define("LANG_LAN_06", "テーブルを作成");
define("LANG_LAN_07", "既存のテーブルを削除？");
...
define("LANG_LAN_21", "言語パック");
define("LANG_LAN_23", "言語パック（ZIP）を作成");
define("LANG_LAN_24", "パック作成");
...
define("LANG_LAN_30", "リリース日");
define("LANG_LAN_31", "互換性");
define("LANG_LAN_32", "インストール済言語");
define("LANG_LAN_33", "検証中にエラーのみを表示する");
