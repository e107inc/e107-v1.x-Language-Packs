...
|
|     $URL: https://e107.svn.sourceforge.net/svnroot/e107/trunk/e107_0.7/e107_languages/Japanese/admin/lan_administrator.php $
|     $Revision: 12903 $
...
define("ADMSLAN_2", "データベースの更新");
define("ADMSLAN_3", "is the main site administrator and cannot be edited.");
define("ADMSLAN_4", "続行");
define("ADMSLAN_5", "エラー!");
define("ADMSLAN_6", "is the main site administrator and cannot be deleted.");
define("ADMSLAN_13", "既存の管理者");
define("ADMSLAN_16", "管理者名");
define("ADMSLAN_17", "管理者パスワード");
define("ADMSLAN_18", "パーミッション");
define("ADMSLAN_19", "サイトの環境設定を変更");
define("ADMSLAN_20", "メニューを変更");
...
define("ADMSLAN_67", "ファイルインスペクターでスキャン");
define("ADMSLAN_68", "メール通知を設定");
define("ADMSLAN_69", "is already an administrator and must be edited.");
define("ADMSLAN_70", "管理者リストに戻る");
define("ADMSLAN_71", "権限を表示するには、ここをクリック");
define("ADMSLAN_76", "言語パックを管理");
