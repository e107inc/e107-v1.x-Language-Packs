...
+---------------------------------------------------------------+
*/
define("LANINS_TITLE", "e107 Kuruluyor");
define("LANINS_000", "Geçersiz aşamada bilgi algılandı! Kurulum durdurdu.");
define("LANINS_001", "Versiyon %1$s");
define("LANINS_002", "Kurulum");
define("LANINS_002a", "(Adım %1$s of 7)");
define("LANINS_003", "1");
define("LANINS_004", "Dil Seçimi");
define("LANINS_004a", "Deçilen Dil");
define("LANINS_004b", "Dil");
define("LANINS_005", "Lütfen kurulum işlemi boyunca kullanacağınız dili seçiniz");
define("LANINS_006", "Dili Ayarla");
define("LANINS_007", "4");
define("LANINS_008", "PHP & MySQL Versiyon Kontrolü / Dosya İzin Kontrolü");
define("LANINS_008a", "Uyumluluk ve Dosya izinleri");
...
define("LANINS_020", "Kuruluma Devam Et");
define("LANINS_021", "2");
define("LANINS_022", "MySQL Sunucu Detayları");
define("LANINS_022a", "Veritabanı");
...
define("LANINS_054", "Seçilen veritabanı varlığı için başarılı bir şekilde kontrol etti.");
define("LANINS_055", "Kurulum Doğrulaması");
define("LANINS_055a", "Onaylama");
define("LANINS_056", "6");
...
define("LANINS_062", "[b]Welcome to your new website![/b] e107 has installed successfully and is now ready to accept content.<br />Your administration section is [link=e107_admin/admin.php]located here[/link], click to go there now. You will have to login using the name and password you entered during the installation process. [b]Support[/b] e107 Homepage: [link=http://e107.org]http://e107.org[/link], you will find the FAQ and documentation here. Forums: [link=http://e107.org/forum.html]http://e107.org/forum.html[/link] Plugin Developer Community: [link=http://www.e107coders.org]http://e107coders.org[/link] [b]Downloads[/b] Plugins: [link=http://plugins.e107.org]http://plugins.e107.org[/link] Themes: [link=http://themes.e107.org]http://themes.e107.org[/link] Thank you for trying e107, we hope it fulfils your website needs. \(You can delete this message from your admin section.\)");
define("LANINS_063", "e107\'ye Hoşgeldiniz");
...
define("LANINS_071a", "Bitti");
define("LANINS_071b", "Kurulum sırasında Sonuçlandırılması Hata");
define("LANINS_071c", "Hataları ile Bitti");
...
define("LANINS_075", "Bu isim kullanıcıların sizin profilinize baktığında, forumda ve diğer alanlarda göreceği isimdir. Kullanıcı adınızla aynı olmasını isterseniz boş bırakın.");
...
define("LANINS_082", "adiniz@siteniz.com");
...
define("LANINS_087", "Çeşitli");
define("LANINS_088", "Ana Sayfa");
define("LANINS_089", "Dosyalar");
define("LANINS_090", "Üyeler");
define("LANINS_091", "Haber Gönder");
define("LANINS_092", "İletişim");
define("LANINS_093", "Özel menü öğelerine erişim ver");
define("LANINS_094", "Örnek özel forum sınıfı");
define("LANINS_095", "Doğruluk Kontrolü");
define("LANINS_096", "En Son Yorumlar");
define("LANINS_097", "[devamı ... ]");
define("LANINS_098", "Haberler");
define("LANINS_099", "e107 CMS");
define("LANINS_100", "En Son Forum Mesajları");
define("LANINS_101", "Menü Seçeneklerini Güncelle");
define("LANINS_102", "Tarih / Saat");
define("LANINS_103", "e107 Eklentiler");
define("LANINS_104", "Kontrol");
...
define("LANINS_DB_UTF8_LABEL", "Utf-8 yapmaya zorla");
define("LANINS_DB_UTF8_CAPTION", "Mysql Karekter");
define("LANINS_DB_UTF8_TOOLTIP", "Eğer set, yükleme komut dosyası veritabanı UTF-8 mümkünse uyumlu hale getirecek. UTF-8 Veritabanı sonraki büyük e107 versiyonu için gereklidir.");
define("LANINS_109", "	Inititated");
define("LANINS_110", "Tamam");
...
define("LANINS_125a", "Hata");
define("LANINS_WELCOME", "	[b]Welcome to your new website![/b] e107 has been installed successfully and is now ready to accept content. Your administration section is [link=e107_admin/admin.php]located here[/link], click to go there now. You will need to login using the name and password which you entered during the installation process. [b]Support[/b] [link=http://e107.org/]e107 Homepage[/link] [link=http://e107.org/support]e107 Forums[/link] [link=http://wiki.e107.org/]e107 Handbook[/link] [link=http://e107turkiye.com/]e107 Türkiye[/link] Thank you for trying e107, we hope it fulfills your website needs.");
define("LANINS_NEWS", "	[b]Welcome![/b] e107 is a content management system written in PHP and using the popular open source MySQL database system for content storage. It is completely free, totally customizable and in constant development. [list][link=http://e107.org/content/Learn-all-about-e107]Everything you need to know about e107[/link]*[link=http://e107.org/content/About-Us:The-Team]Dev Team | Translators | Support Team[/link]*[link=http://wiki.e107.org/]Documentation Wiki[/link]*[link=http://e107turkiye.com/]e107 Türkiye Destek[link][/list]");
?>