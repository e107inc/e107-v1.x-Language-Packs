...
|
|     $Source: /cvsroot/e107/e107_langpacks/e107_languages/Thai/lan_userclass.php,v $
|     $Revision: 1.2 $
...
*/
define("UC_LAN_0", "บุคคลทั่วไป");
define("UC_LAN_1", "แขกรับเชิญ");
define("UC_LAN_2", "ยังไม่เปิดใช้งาน");
define("UC_LAN_3", "สมาชิกระบบ");
define("UC_LAN_4", "ให้อ่านอย่างเดียว");
define("UC_LAN_5", "ผู้จัดการระบบ");
define("UC_LAN_6", "ผู้บริหารระบบ");
?>