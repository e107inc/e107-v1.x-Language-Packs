...
|
|     $Source: /cvsroot/e107/e107_langpacks/e107_languages/Thai/lan_membersonly.php,v $
|     $Revision: 1.2 $
...
*/
define("PAGE_NAME", "เฉพาะสมาชิกเท่านั้น");

define("LAN_MEMBERS_0", "เขตพื้นที่เฉพาะ");
define("LAN_MEMBERS_1", "ที่นี่เป็นเขตพื้นที่เฉพาะ");
define("LAN_MEMBERS_2","ต้องการเข้าระบบ กรุณาคลิก <a href='".e_LOGIN."'>เข้าสู่ระบบ</a>");
define("LAN_MEMBERS_3","หรือ<a href='".e_SIGNUP."'>ลงทะเบียน</a> เป็นสมาชิก");
define("LAN_MEMBERS_4","คลิกไปหน้าแรกที่นี่");
