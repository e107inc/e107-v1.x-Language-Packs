...
|
|     $Source: /cvsroot/e107/e107_langpacks/e107_languages/Thai/lan_sitedown.php,v $
|     $Revision: 1.2 $
...
*/
define("PAGE_NAME", "อยู่ระหว่างปิดปรับปรุงเว็ปไซท์ชั่วคราว");
define("LAN_SITEDOWN_00", "ปิดปรับปรุงเว็ปไซท์ชั่วคราว");
define("LAN_SITEDOWN_01", "กำลังอยู่ระหว่างการปิด เพื่อปรับปรุงพัฒนาเว็ปไซท์ชั่วคราว ขออภัยในความไม่สะดวก แล้วพบกันใหม่เร็วๆนี้ครับ 
ขอขอบคุณ");
