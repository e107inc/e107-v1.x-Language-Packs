...
|
|     $Source: /cvsroot/e107/e107_langpacks/e107_languages/Thai/lan_date.php,v $
|     $Revision: 1.2 $
...
define("LANDT_01", "ปี");
define("LANDT_02", "เดือน");
define("LANDT_03", "สัปดาห์");
define("LANDT_04", "วัน");
define("LANDT_05", "ชั่วโมง");
define("LANDT_06", "นาที");
define("LANDT_07", "วินาที");
define("LANDT_01s", "ปี");
define("LANDT_02s", "เดือน");
define("LANDT_03s", "สัปดาห์");
define("LANDT_04s", "วัน");
define("LANDT_05s", "ชั่วโมง");
define("LANDT_06s", "นาที");
define("LANDT_07s", "วินาที");

define("LANDT_08", "นาที");
define("LANDT_08s", "นาที");
define("LANDT_09", "วินาที");
define("LANDT_09s", "วินาที");
define("LANDT_AGO", "ที่ผ่านมา");
