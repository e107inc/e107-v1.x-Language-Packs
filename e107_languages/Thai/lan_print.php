...
|
|     $Source: /cvsroot/e107/e107_langpacks/e107_languages/Thai/lan_print.php,v $
|     $Revision: 1.2 $
...
*/
if (!defined("PAGE_NAME")) {define("PAGE_NAME", "พิมพ์");}
define("LAN_PRINT_86", "หมวด");
define("LAN_PRINT_87", "โดย");
define("LAN_PRINT_94", "ส่งโดย");
define("LAN_PRINT_135", "ข่าว:เนื้อหาใหม่");
define("LAN_PRINT_303", "รายการข่าว:เนื้อหาใหม่นี้มาจาก");
define("LAN_PRINT_304", "เรื่อง");
define("LAN_PRINT_305", "หัวข้อย่อย");
define("LAN_PRINT_306", "มาจาก");
define("LAN_PRINT_307", "พิมพ์หน้านี้");
define("LAN_PRINT_1", "พิมพ์");
