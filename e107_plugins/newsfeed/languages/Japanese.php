...
define("NFLAN_05", "編集");
define("NFLAN_06", "削除");
define("NFLAN_07", "既存のニュースフィード");
define("NFLAN_08", "ニュース配信フロントページ");
define("NFLAN_09", "ニュースフィードを作成");
