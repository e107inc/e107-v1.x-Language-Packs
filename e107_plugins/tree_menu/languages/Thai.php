...
|
|     $Source: /cvsroot/e107/e107_langpacks/e107_plugins/tree_menu/languages/Thai.php,v $
|     $Revision: 1.2 $
...
*/
define("TREE_L1", "ตั้งค่าเมนูแบบTree");
define("TREE_L2", "ปรับปรุงการตั้งค่าเมนูแบบTree");
define("TREE_L3", "การตั้งค่าเมนูแบบTree ได้ถูกบันทึกแล้ว");
define("TREE_L4", "เปิด");
define("TREE_L5", "ปิด");
define("TREE_L6", "CSS class ที่จะใช้กับ non-openable links");
define("TREE_L7", "CSS class ที่จะใช้กับ openable links");
define("TREE_L8", "CSS class ที่จะใช้กับ opened links");
define("TREE_L9", "ใช้ spacer class ในระหว่างเมนูเชื่อมโยงหลัก");
