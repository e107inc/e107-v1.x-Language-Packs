...
/*
+---------------------------------------------------------------+
|        e107 website content management system Japanese Language File
|        Released under the terms and conditions of the
|        GNU General Public License (http://gnu.org).
|
|        $URL: ../e107_plugins/pm/languages/admin/Japanese.php $
|        $Revision: 1.0 $
|        $Id: 2013/05/08 17:36:48 $
|        $Author: e107-admin $
+---------------------------------------------------------------+
*/
...
define("ADLAN_PM_2", "プライベートメッセンジャーの設定");
define("ADLAN_PM_3", "PM settings not found, default values set");
define("ADLAN_PM_4", "オプションの更新");
...
define("ADLAN_PM_12", "PM オプション");
define("ADLAN_PM_13", "PM Conversion");
define("ADLAN_PM_14", "PMリミット");
