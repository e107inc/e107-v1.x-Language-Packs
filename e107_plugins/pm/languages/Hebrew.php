...
/*
+---------------------------------------------------------------+
|        e107 website content management system Hebrew Language File
|        Released under the terms and conditions of the
|        GNU General Public License (http://gnu.org).
|
|        $URL: ../e107_plugins/pm/languages/Hebrew.php $
|        $Revision: 1.0 $
|        $Id: 2013/04/10 17:52:08 $
|        $Author: Sharon $
+---------------------------------------------------------------+
*/

define("LAN_PM", "הודעה פרטית");
define("LAN_PM_1", "שלח הודעה פרטית");
define("LAN_PM_2", "אל");
define("LAN_PM_3", "תצוגה מקדימה");
define("LAN_PM_4", "Userclass");
define("LAN_PM_5", "נושא");
define("LAN_PM_6", "הודעה");
define("LAN_PM_7", "Emotes");
define("LAN_PM_8", "קובץ מצורף");
define("LAN_PM_9", "Read receipt	");
define("LAN_PM_10", "Send me an email when this PM is read	");
define("LAN_PM_11", "הוסף העלאה חדשה");
